				...
				<div class="container">
					<div class="row">
						<div class="col s12 m6 l6">
							<h5 class="breadcrumbs-title mt-0 mb-0"><span>My All Seasons ({{ allItems.length }})</span></h5>
						</div>
						<div class="col s12 m6 l6">
...
<script>
	export default {
  		...
  		methods: {
  			getData () {
  				this.$axios.get('/api/prtalOnlyGet/allSeasons').then(res => {
  			...
  			setOrder () {
  				this.$axios.get('/api/prtalOnlyGet/setSeasons');
